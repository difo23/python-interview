...
def ecuCuad(a, b, c):
    ...
    verificador = (b**2) - (4*a*c)        # si el discriminante > 0 tendras dos posible soluciones
    # si el discriminante == 0 tendra solo una posible solucion
    if verificador == 0:
