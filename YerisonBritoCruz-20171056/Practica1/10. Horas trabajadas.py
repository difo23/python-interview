...
sueldoBruto = 0
salarioExtra = 0
restrincion = 110    # 10% de 1100 retenciones
restrincion2 = 225   # 15% de 1500 retenciones
...
while salarioHora >= 200:
    ...
    restrincion3 = (sueldoBruto-2600)*0.25   # Retenciones no aplican a las horas extras

    if horaExtras > 0:                       # si trabajo mas de 40 horas
